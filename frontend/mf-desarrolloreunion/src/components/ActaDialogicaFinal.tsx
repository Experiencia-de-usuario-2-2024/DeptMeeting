...
const ActaDialogicaFinal: React.FC = () => {
    ...
    const [deptTopics, setDeptTopics] = React.useState<any[]>([]);
            ...
            {estadoReunion === "Finalizada" || estadoReunion === "finalizada" ? (
                <>
                                ...
                                <div style={{
                                    ...
                                    <Inline space="space.100">
                                        ...
                                        <h4 style={{
                                            margin: 0,
                                            marginTop: '2px'
                                        }}>Real: &#60;{meetingminute?.realStartTime.split(",")[0]} {meetingminute?.realStartTime.split(",")[1].split(":").slice(0, 2).join(":")}&#62; &#60;{meetingminute?.realEndTime.split(",")[0]} {meetingminute?.realEndTime.split(",")[1].split(":").slice(0, 2).join(":")}&#62;</h4>
                                    </Inline>
                            ...
                            <div>
                                ...
                                <Box padding="space.400" backgroundColor="color.background.discovery" xcss={boxStyles}>
                                    ...
                                    <h3 style={{
                                        marginTop: "5px",
                                        marginBottom: "5px"
                                    }}>Objetivo: {meetingminute?.title}</h3>
                                    <br/>
                                    {/* lugar */}
                                    <h3 style={{
                                        marginTop: "5px",
                                        marginBottom: "5px"
                                    }}>Lugar: {meetingminute?.place}</h3>
                                    <br/>
                                    {/* anfitriones */}
                                ...
                                {compromisosProyecto?.length != 0 && (
                                    <>
                                        <Box padding="space.400" backgroundColor="color.background.discovery"
                                            ...
                                            <h3 style={{marginTop: "5px", marginBottom: "5px"}}>Compromisos
                                                previos:</h3>
                    ...
                    <div style={{
                        ...
                        <h3 style={{textAlign: 'center'}}> Antes de descargar el PDF de la reunión, procure cerrar los
                            dos menus laterales, cuyos botones se encuentran en la parte superior izquierda y derecha de
                            la página, además de mantener el navegador en pantalla completa, para que el PDF se genere
                            correctamente.</h3>
                        {/* // window.alert("Por favor, procure cerrar los dos menus laterales, cuyos botones se encuentran en la parte superior izquierda y derecha de la página para que el PDF se genere correctamente."); */}
                        <ButtonGroup>
                            <Inline space="space.200" alignInline="center">
                                <Button onClick={() => cancelarOperacion()}
                                        style={{marginTop: '20px', marginBottom: '20px'}}>Regresar al inicio</Button>
                                <Button appearance="primary" onClick={() => {
                                    descargarPdf()
                                }} style={{marginTop: '20px', marginBottom: '20px'}}>Descargar PDF reunión</Button>
                            </Inline>
                        </ButtonGroup>
                    </div>

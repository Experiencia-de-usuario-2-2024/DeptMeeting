...
const FormularioEnReunion: React.FC = () => {
    ...
    useEffect(() => {
        ...
        async function obtenerMeetingMinutePorId() {
            try {
                // Solo se requiere del token del usuario para realizar la petición
                const response = await axios.get(`http://deptmeeting.diinf.usach.cl/api/api/meeting-minute/` + localStorage.getItem('idMeetingMinute'), {
                    headers: {
                        Authorization: `Bearer ${tokenUser}`
                    }
                });
    ...
    const guardarFormularioFinal = () => {
        ...
        async function actualizarActa() {
            ...
            try {           
                const response = await axios.put(`http://deptmeeting.diinf.usach.cl/api/api/meeting-minute/` + idMeetingMinute, {
    ...
    const guardarCompromiso = () => {
        ...
        async function crearCompromiso() {
            try {            
                const response = await axios.post(`http://deptmeeting.diinf.usach.cl/api/api/element`, {

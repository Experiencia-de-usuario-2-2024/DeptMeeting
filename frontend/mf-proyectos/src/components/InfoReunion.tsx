...
const InfoReunion: React.FC = () => {
    ...
    useEffect(() => {
        ...
        async function obtenerReunionPorId() {
            try {
                ...
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/meeting/` + idReunion, {
                    headers: {
    ...
    const minutaPorId = (idReunion: string) => {
        async function obtenerMeetingMinute() {
            try {
                // Solo se requiere del token del usuario para realizar la petición
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/meeting-minute/reunion/` + idReunion, {
                    headers: {
                        Authorization: `Bearer ${tokenUser}`
                    }
                });
    ...
    async function cambiarEstado(idReunion: string) {
        try {            
            const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/meeting/` + idReunion, {
                state: "Pre-reunión"
            },{
                headers: {
                    Authorization: `Bearer ${tokenUser}`
    ...
    const irReunion = () => {
        ...
        async function obtenerMeetingMinute() {
            ...
            try {
                // Solo se requiere del token del usuario para realizar la petición
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/meeting-minute/reunion/` + aux, {
                    headers: {
                        Authorization: `Bearer ${tokenUser}`
                    }
                });

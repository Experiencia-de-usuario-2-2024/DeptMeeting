...
export class ElementDTO {
    ...
    // postition: string; // posicion del elemento dentro del tema en que se añadio -> mal escrito
    position: string; // posicion del elemento dentro del tema en que se añadio
    ...
    createdBy: string; // usuario que creo el elemento
    editedBy: string[]; // usuarios que han editado el elemento
    sentiment: string; // sentimiento del elemento
    emotion: string; // emocion del

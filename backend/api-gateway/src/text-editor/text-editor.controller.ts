...
export class TextEditorController {
  ...
  async addProject(@Body() textEditor: any, @Req() req: any) {
    ...
    return this._clientProxyTextEditor.send('CREAR_TEXT_EDITOR', textEditor);
  }
  ...
  async findOne(@Param('id') id: string) {
    ...
    return this._clientProxyTextEditor.send('BUSCAR_UN_TEXT_EDITOR', id);
  }
  ...
  async findAll() {
    ...
    return this._clientProxyTextEditor.send('BUSCAR_TODOS_TEXT_EDITOR', '');
  }
  ...
  async update(
    ...
    return this._clientProxyTextEditor.send('ACTUALIZAR_TEXT_EDITOR', {
      id,
      textEditor,
    });
  }

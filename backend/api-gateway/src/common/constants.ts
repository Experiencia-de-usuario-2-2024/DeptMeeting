...
export enum MeetingMinuteMSG {
  ...
  ADD_ELEMENT_TO_TOPIC = 'ADD_ELEMENT_TO_TOPIC',
  VOTE = 'VOTE',
  GET_MEEETING_MINUTES_NOT_APPROVED = 'GET_MEEETING_MINUTES_NOT_APPROVED',
  ADD_COMISSION_TO_TOPIC = 'ADD_COMISSION_TO_TOPIC',
}

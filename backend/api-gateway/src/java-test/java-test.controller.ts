...
export class JavaTestController {
  ...
  async create(@Body() javaTest: any): Promise<Observable<IJavaTest>> {
    return this._ClientProxyJavaTest.send('create', javaTest);
  }
  ...
  async findAll(): Promise<Observable<IJavaTest[]>> {
    return this._ClientProxyJavaTest.send('getAll', '');
  }
  ...
  async findOne(@Param('id') id: string) {
    return this._ClientProxyJavaTest.send('getForId', id);
  }
  ...
  async update(
    ...
    return this._ClientProxyJavaTest.send('update', { id, javaTest });
  }
